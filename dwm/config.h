...
static const char dmenufont[] = "JetBrains Mono:style=Regular:pixelsize=11:antialias=true:autohint=true";
...
//
// static const char col_cursor[] = "#FAD566"; // cursor (regular4)
// static const char col_currev[] = "#efdaa1"; // reverse-cursor (regular6)
// static const char col_bg[] = "#1a1b26";     // background
// static const char col_fg[] = "#F3F2CC";     // text

static const char col_bg[] = "#181616";       /* main background */
static const char col_fg[] = "#c5c9c5";       /* main foreground */
static const char col_black[] = "#0d0c0c";    /* normal black */
static const char col_red[] = "#c4746e";      /* normal red */
static const char col_green[] = "#8a9a7b";    /* normal green */
static const char col_yellow[] = "#c4b28a";   /* normal yellow */
static const char col_blue[] = "#8ba4b0";     /* normal blue */
static const char col_magenta[] = "#a292a3";  /* normal magenta */
static const char col_cyan[] = "#8ea4a2";     /* normal cyan */
static const char col_white[] = "#C8C093";    /* normal white */
static const char col_bblack[] = "#a6a69c";   /* bright black */
static const char col_bred[] = "#E46876";     /* bright red */
static const char col_bgreen[] = "#87a987";   /* bright green */
static const char col_byellow[] = "#E6C384";  /* bright yellow */
static const char col_bblue[] = "#7FB4CA";    /* bright blue */
static const char col_bmagenta[] = "#938AA9"; /* bright magenta */
static const char col_bcyan[] = "#7AA89F";    /* bright cyan */
static const char col_bwhite[] = "#c5c9c5";   /* bright white */
